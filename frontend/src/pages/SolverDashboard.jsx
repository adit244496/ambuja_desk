            ...
            {panelTicket && (() => {
                ...
                return (
                    <div className={isClosing ? "slide-out-right-panel ticket-details-panel" : "slide-in-right-panel ticket-details-panel"} style={{
                        ...
                        <div className="ticket-details-panel-body" style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain', touchAction: 'pan-y', padding: '24px 30px', zIndex: 10, display: 'flex', flexDirection: 'column' }}>
